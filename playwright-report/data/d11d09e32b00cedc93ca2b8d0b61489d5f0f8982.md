...
- Name: malaria-visual.spec.js >> Visual - High Risk Ward Selected >> environmental factors card shows High ward values
- Location: tests/malaria-visual.spec.js:98:9
...
Locator: locator('.enviro-factors')
Timeout: 5000ms
  Timeout 5000ms exceeded.

  Snapshot: env-factors-high.png

Call log:
  - Expect "toHaveScreenshot(env-factors-high.png)" with timeout 5000ms
    - verifying given screenshot expectation
  - waiting for locator('.enviro-factors')
    - locator resolved to <section class="card enviro-factors">…</section>
...
```ts
  ...
  3   | import { setupMalariaPage, drillToWard } from './helpers/malaria.js';
  4   | 
  5   | // ---------------------------------------------------------------------------
  6   | // VISUAL REGRESSION TESTS
  7   | //
  8   | // First run: Playwright creates baseline snapshots in tests/__snapshots__/.
  9   | // Subsequent runs: diffs against those baselines.
  10  | //
