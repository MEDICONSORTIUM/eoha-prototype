...
- Name: malaria-visual.spec.js >> Visual - High Risk Ward Selected >> ward risk donut shows High state
- Location: tests/malaria-visual.spec.js:92:9
...
Locator: locator('.risk-card').first()
Timeout: 5000ms
  Timeout 5000ms exceeded.

  Snapshot: ward-risk-high.png

Call log:
  - Expect "toHaveScreenshot(ward-risk-high.png)" with timeout 5000ms
    - verifying given screenshot expectation
  - waiting for locator('.risk-card').first()
    - locator resolved to <section class="card risk-card">…</section>
